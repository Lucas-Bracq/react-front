...
const BarathonThumb= ({barathon,pubs}: IProps): JSX.Element => {
    ...
    return (
        <>
            <SBarathon>
                ...
                <Button type="button" onClick={toggleMap}>{isOpened ? 'Cacher' : 'Voir la map'}</Button>
                {isOpened && (
